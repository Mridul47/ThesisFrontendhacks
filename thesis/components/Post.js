import { EllipsisHorizontalIcon, GiftIcon } from "@heroicons/react/24/solid";
...
function Post({ id, post, postPage }) {
    ...
    useEffect(
        () =>
            setLiked(
                //findIndex works similar like map. findIndex is for array. it has a predicate and a value
                ...
                >
                    ...
                    {session.user.uid === post?.id ? (
                        ...
                        <div className="flex items-center space-x-1 group">
                            <div className="icon group-hover:bg-green-500/10">
                                <EllipsisHorizontalIcon className="h-5 group-hover:text-green-500" />
                            </div>
                        </div>
                    )}
                    ...
                    >
                        <div className="icon group-hover:bg-pink-600/10">
                            {liked ? (
                                <GiftIcon className="h-5 text-[#ff7f11]" />
                            ) : (
                                <GiftTopIcon className="h-5 group-hover:text-[#aa7242]" />
                            )}
                        </div>
                        {likes.length > 0 && (
                            <span
