import { ChartBarIcon, ChatBubbleOvalLeftIcon, GiftTopIcon, ShareIcon } from "@heroicons/react/24/outline";
import { EllipsisHorizontalCircleIcon, GifIcon } from "@heroicons/react/24/solid";
                ...
                <div className="text-[#6e767d] flex justify-between w-10/12">
                    ...
                    <div className="flex items-center space-x-1 group">
                        <div className="icon group-hover:bg-pink-600/10">
                            <GiftTopIcon className="h-5 group-hover:text-pink-600" />
                        </div>
